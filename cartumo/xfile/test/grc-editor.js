                ...
                editor: {
                    src: {
                        "compat.js": function (e, t, r) {
                            ...
                            s = jQuery, t.exports = {
                                dom_ready: function () {
                                    ...
                                    (e = e || TVE.Editor_Page.editor).find(TVE.ELEM.text).each(function () {
                                        s(this).find("span").each(function () {
                                            var e = s(this), t = !1, r = !1, i = !1, n = !1;
                                    ...
                                    (e = e || s("#tve_editor")).find(".thrv_text_element").not("div").removeClass("thrv_text_element"), e.find(".thrv-styled_list .thrv-inline-text").removeClass("thrv-inline-text").addClass("thrv-advanced-inline-text");
                                    for (var t, r = TVE.ELEM.text, i = TVE.ELEM.headings, n = e.find(r).not(TVE.TEXT_INLINE).not(".thrv_custom_html_shortcode *, .tve_wp_shortcode *, .thrive-shortcode-html *, .tve_scT > ul, .widget-title").not(".wp-caption-text"), a = s(); n.length;) {
                                        for (a = t = n.first(); t.next().is(r);) a = a.add(a.next()), t = t.next();
                                        n = n.not(a), 1 === a.length && a.is(i) ? t.parents(TVE.TEXT_HEADINGS + "," + TVE.TEXT_BLOCK).length || a.wrap('<div class="thrv_wrapper thrv_heading"></div>') : t.closest(".thrv_text_element, .fr-element").length || a.wrapAll('<div class="thrv_wrapper thrv_text_element"></div>')
                                    }
                                    ...
                                    (e = e || s("#tve_editor")).find(".tcb-flex-row.thrv_wrapper").each(function (e, t) {
                                        var r = s(t);
                                    ...
                                    (e = e || s("#tve_editor")).find(".thrv_heading").each(function (e, t) {
                                        var r = jQuery(t);
                            ...
                            var u, b, i, n, a, c, d, s, f, o, l, _, v, h, V, p, g, m, E, T, y, w, x, C, S, R, A, k, O,
                                L;
                            u = jQuery, c = ".thrv_wrapper:not(.thrv_widget_menu *,.thrv_text_element,.tve_w_menu li,.canvas-mode,.thrv-styled_list *,.thrv-numbered_list *,.tve_no_drag,.symbol-edit-mode,.symbol-edit-mode *), .tve-draggable:not(.canvas-mode,.symbol-edit-mode), .tve_lp_header, .tve_lp_content, .tve_lp_footer, " + "ul,ol,address,blockquote,p".split(",").map(function (e) {
                                ...
                                init: function () {
                                    ...
                                    !v && e.ctrlKey && (v = !0), !h && e.altKey && (h = !0), 9 === e.which && TVE.ActiveElement && TVE.ActiveElement.parent().hasClass("tve_table_cell") && (TVE.do_action("tab-pressed", TVE.ActiveElement), e.preventDefault(), e.stopPropagation())
                                }, keyup: function (e) {
                                    h = v = !1
                                    ...
                                    if ((f = u(e.currentTarget)).hasClass("tve-drag-handle") && (f = O.get_dragged_target(f)), y(f)) return f = null, !1;
                                    (f = f.is(".tve_grabbed") ? u("." + _) : f).parent().is("a") && (f = f.parent()), TVE.state(TVE.STATE_DRAG), TVE.froala.disable(f), f.addClass("tve-dragged").removeClass("active_delete active_duplicate"), O.body_class(), e.stopPropagation(), e.originalEvent.dataTransfer.setData("text/plain", ""), e.originalEvent.dataTransfer.setDragImage(a, 25, -25), f.is(d) && (V.force_limit_vertical = !0), TVE.FLAGS.$dragged_element = f, TVE.FLAGS.$dragged_element_parent = f.parent(), TVE.do_action("tcb.dragstart", f);
                                    var t = f.closest(s);
                                    0 === t.length && u(s).addClass("tve-no-drop-inside"), o = !f.is(s) && 0 < t.length ? t : null
                                }, main_drag_start: function (e) {
                                    if (TVE.state(TVE.STATE_DRAG), u(s).addClass("tve-no-drop-inside"), O.body_class(), e.static_element) {
                                    ...
                                    if ((f || p.dragged_elem) && "tve-drop-handle" !== e.target.id) {
                                        ...
                                        if (!f || e.target !== f[0] && !u.contains(f[0], e.target)) {
                                            ...
                                            if (x(A) && (0 === o.length || 1 === o.length && "absolute" === o.css("position"))) return a = (n = A)[0].classList, s = a.contains("tve-page-section-in") || a.contains("tve-cb") || a.contains("tve_reveal_container"), (s = TVE.apply_filters("tcb.allow_drop_near", s, n)) ? (V.dropzone_element = !0, A.is(d) && (V.limit_vertical = !0)) : V.position_mid(A), !1;
                                            if (A.children(T()).length < 2 && !A.is(".thrv_wrapper.thrv_lead_generation") && (A = A.closest(T())), !w(A)) {
                                                var l = A.parents(T()).first();
                                                return l.length && u.contains(TVE.Editor_Page.editor, l) ? (e.target = l[0], (A = l).trigger(e), !1) : void(A = null)
                                            }
                                            return V.last_dir = null, e.preventDefault(), A.is(d) && (V.limit_vertical = !0), V.can_position_mid = !V.FORBID_MIDDLE && !C(A[0], "thrv_text_element") && x(A) && 0 === A.children(c).length, !1
                                        }
                                        A = null
                                    }
                                }, dragover: function (e) {
                                    var t;
                                    if ((e.preventDefault(), A) && (("tve-drop-handle" !== (t = A)[0].id && w(t) || V.dropzone_element) && !(f && u.contains(f[0], A[0]) || o && 0 === o.find(A).length))) return V.position(A, e), e.originalEvent.dataTransfer.dropEffect = "copy", TVE.do_action("tcb.dragover", A, V), !1
                                }, dragover_body: function (e) {
                                    if (TVE.do_action("tcb.dragover_body", e), V && V.data("tt")) return !1
                                }, dragleave: function (e) {
                                    return O.cancel_dragleave ? delete O.cancel_dragleave : V.last_dir = null, !1
                                }, drop: function (e) {
                                    return e.preventDefault(), e.stopPropagation(), !(!p.dragged_elem && !f || !V.data("tt") || !V.data("tt")[0]) && (!!TVE.apply_filters("allow_drop", !0, [p.dragged_elem || f, V]) && (f && u.contains(f[0], V.data("tt")[0]) ? void 0 : (i.removeClass("tve-dragging tve-empty-placeholder"), f && f.removeClass("tve-dragged"), V.hide(), l.hide(), p.dragged_elem ? O.fetch(p.dragged_elem, V.data("tt")) : (!0 !== h || TVE.main.EditMode.in_edit() || (f = f.clone()), O.insert(f, V.data("tt"))), TVE.do_action("tcb.element.dropped", {
                                    ...
                                    TVE.BROWSER.mozilla || TVE.Editor_Page.editor.find("a,img").not(E()).attr("draggable", "false"), TVE.Editor_Page.editor.find("a.tcb-button-link").attr("draggable", "false"), L.bind(), u("#tve-drag-clone").remove(), S().addClass("tve_empty_dropzone")
                                }, fetch: function (e, t) {
                                    if (!1 === this.before_fetch(e, t)) return !1;
                                    t = TVE.apply_filters("tcb.change_target", t, V);
                                    var r = e.type;
                                    if (TVE.renderers[r]) return O.insert(TVE.renderers[r].render_default(), t, !1, !1, !0), !0;
                                    var i = TVE.main.static_element(r);
                                    if (i.length <= 0) return !1;
                                    var n = i.first().clone();
                                    return n.find(".tve_countdown_timer_evergreen").attr("data-id", "evergreen_" + Math.floor(1e4 * Math.random())), O.insert(n.html(), t, !1, !1, !0), !0
                                    ...
                                    var a = u(e);
                                    return r ? t.html(a) : i ? t.replaceWith(a) : this.insert_near(a, t, V.data("dir")), this.bind_draggable(a), void 0 !== n && n && O.after_fetch(a, t, V.data("dir")), O.after_drop(a, t, V.data("dir")), setTimeout(function () {
                                        TVE.Editor_Page.after_action(), O.refresh(), a.hasClass("tcb-elem-placeholder") ? a.children(".tcb-inline-placeholder-action").first().trigger("click") : n && (a.is(TVE.TEXT_ALL) ? TVE.froala.force_focus(a) : TVE.Editor_Page.selection_manager.select_element(a))
                                    }, 400), TVE.prevent_blur || (TVE.Editor_Page.enable(), TVE.Editor_Page.blur()), TVE.do_action("tcb.after-insert", a), a
                                    ...
                                    e.is(".thrv-content-block, .thrv-styled_list, .thrv-numbered_list") && 0 === e.find(g.get("mouseover")).length ? e.remove() : (O.ensure_column_placeholder(e), TVE.main.trigger("after-element-removed", e))
                                    ...
                                    r.addClass("tcb-el-loading"), TVE.ajax("load_content_template", "post", {template_key: e}).done(function (e) {
                                        ...
                                        t = TVE.Editor_Page.content_manager.process_saved_template(e.css_code, t, e.media_css, e.imports), r.removeClass("tcb-el-loading"), O.insert(t, r, !1, !0), TVE.do_action("tcb.insert_content_template")
                                    }).always(function () {
                                    ...
                                    }), a && (e.css("padding-top", "0px"), e.parent().css("margin-top", "0px")), s && (e.css("padding-bottom", "0px"), e.parent().css("margin-bottom", "0px")), L.bind(e)
                                }, position_resizables: function (e, t) {
                                    L.position_handles(e, t)
                                }, bind_element: function (e) {
                                    this.bind_draggable(e), L.bind(e)
                                ...
                                position_handles: function (e, t) {
                                    ...
                                    t.find(".ui-resizable-handle").remove(), t.each(function () {
                                        ...
                                        handles: "e", start: function (e, t) {
                                            ...
                                            }), d && (l.left_column.head_css({"max-width": d.elem + "%"}), l.right_column.head_css({"max-width": d.next + "%"})), l.left_column.css("width", "").css("height", ""), n.css({"max-width": ""}), i.removeClass("tcb-resizing"), TVE.FLAGS.drag = !1, l.left_column.find(".ui-resize-left, .ui-resize-right").remove(), O.resize_images(i), TVE.Editor_Page.after_action(), TVE.do_action("tcb.columns.resized", l)
                                        }, resize: function (e, t) {
                            ...
                            }, O.get_draggable_elements = E, t.exports = O
                            ...
                            c = jQuery, t.exports = {
                                ...
                                duplicate_element: function (e) {
                                    ...
                                    return t ? e.parent().after(r) : e.after(r), e.data("tve-el-type") && r.data("tve-el-type", e.data("tve-el-type")), r.add(r.children()).removeClass("edit_mode canvas-mode active_highlight active_delete on_hover active_duplicate"), TVE.drag.after_clone(e, r), TVE.do_action("tcb.element.duplicate", e, r), this.reposition_icons(), this
                                },
                            ...
                            "content.js": function (e, t, r) {
                                ...
                                g = jQuery, t.exports = {
                                    ...
                                    cleanup_froala: function (e) {
                                        e.find(".tve-froala").each(function () {
                                            ...
                                            var e = g(this), t = e.children(".fr-element");
                                            g(this).replaceWith(t.length ? t.html() : e.html())
                                        })
                                    },
                                    ...
                                    get_clean_content: function (e, t) {
                                        ...
                                        var r = g("#pre-save-filter");
                                        r.length || (r = g('<div style="display:none" id="pre-save-filter"></div>').appendTo("body")), r.empty();
                                        ...
                                        return r.html(i.html().replace(/<script type="text\/javascript">/g, '<script type="tcb/temp">')), e.keep_wp_shortcodes || r.find(".tve_shortcode_rendered").remove(), r.find(".tcb-remove-on-save, .ui-resizable-handle, .ui-resize-left, .ui-resize-right, .thrive-symbol-shortcode, .thrive-shortcode-html:not(.tve-custom-menu-type), grammarly-btn,.tve_custom_html_placeholder,.tve_dropzone,.rangySelectionBoundary, .tve_shortcode_overlay,.tve_shortcode_rendered script, .tcb-remove-on-save, .tve_post_grid_wrapper,.tve_widget_container,.gr-textarea-btn_status,.gr-textarea-btn, .tve-remove-auxiliary-content, .thrv_symbol.tcb-elem-placeholder").remove().end().find(".canvas-mode, .thrv_symbol, .edit_mode, .tve_merge_cells, .tve_merge_selected, .tve_active_hyperlink, .active_highlight, .active_delete, .active_duplicate, .tcb_bring_front").removeClass("edit_mode tve_merge_cells tve_merge_selected, tve_active_hyperlink active_highlight active_delete active_duplicate canvas-mode tve-element-overlay tcb_bring_front symbol-edit-mode").end().find(".tve_toggle_open").removeClass("tve_toggle_open").end().find(".tve_toggle_open_text").removeClass("tve_toggle_open_text").end().find(".tve_faqC").hide().end().find(".tve_oFaq").removeClass("tve_oFaq").end().find(".ui-resizable,.init_done,.ui-sortable,.ui-sortable-handle,.tve-draggable,.tve-droppable").removeClass("ui-resizable init_done ui-sortable ui-sortable-handle tve-draggable tve_grabbed tve-droppable").end().find("[contenteditable]").removeAttr("contenteditable").end().find("[draggable]").removeAttr("draggable").end().find("[data-gramm]").removeAttr("data-gramm data-gramm_id data-gramm_editor").filter(":empty").remove().end().end().find(".tve-state-hover,.tve-state-active").removeClass("tve-state-hover").end().find(".tve-m-expanded").removeClass("tve-m-expanded").end().find(".on_hover").removeClass("on_hover").end().find(".tve-triggered-icon").removeClass("tve-triggered-icon").end().find(".thrv_widget_menu").removeClass("tve-custom-menu-switch-icon-tablet tve-custom-menu-switch-icon-mobile").end().find(".expand-children").removeClass("expand-children").end().find('[data-css=""]').removeAttr("data-css").end().find(".tcb-mp").css("z-index", "").removeClass("tcb-mp").end().find("p").each(function () {
                                            ...
                                            -1 !== t.getAttribute("type").indexOf("quicktime") && t.removeAttribute("type")
                                        }), (r = TVE.apply_filters("tcb_filter_html_before_save", r)).find("a[data-tcb-href]").each(function () {
                                    ...
                                    refresh_global_style_node: function () {
                                        ...
                                        g.each(e.fonts, function (e, t) {
                                            i += t
                                        }), g.each(e.css, function (e, t) {
                                            i += "@media " + e + "{";
                                    ...
                                    parse_element_classes: function (e) {
                                        ...
                                        return e ? g.trim(e.replace(t, "").replace("/S+/g", " ")) : ""
                                    },
                                    ...
                                    prepare_save_data: function (e, t) {
                                        ...
                                        n = TVE.apply_filters("tcb_save_post_data_before", n), TVE.CONST.custom_post_data && g.each(TVE.CONST.custom_post_data, function (e, t) {
                                            n[e] = t
                                        ...
                                        }), TVE.CONST.social_fb_app_id && (n.social_fb_app_id = TVE.CONST.social_fb_app_id), 0 < TVE.Editor_Page.editor.find(".tve-fb-comments").length && -1 === TVE.CONST.tve_globals.js_sdk.indexOf("fb") && TVE.CONST.tve_globals.js_sdk.push("fb"), g.each(TVE.CONST.tve_globals, function (e, t) {
                                            e && (n.tve_globals[e] = t)
                                        }), custom_font_classes && g.each(custom_font_classes.split(" "), function (e, t) {
                                            (TVE.Editor_Page.editor.find("." + t).length || TVE.landing_fonts && TVE.landing_fonts.fontUsed(t)) && n.custom_font_classes.push(t)
                                        }), n.tve_globals.extra_fonts && g.each(n.tve_globals.extra_fonts, function (e, t) {
                                        ...
                                        }), void 0 !== t && g.each(t, function (e, t) {
                                            n[e] = t
                                        });
                                        ...
                                        var _ = g(".tve-fb-comments:visible");
                                        if (0 < _.length) {
                                            var h = _.attr("data-fb-moderator-ids");
                                            void 0 !== h && "" != h && (n.tve_globals.fb_comment_admins = JSON.stringify(h.split(";")))
                                        }
                                        return g(".tve_post_grid_masonry").length && (n.tve_has_masonry = 1), g(".tve_typefocus").length && (n.tve_has_typefocus = 1), (g(".tve_wistia_popover:visible").length || g(".tve_ea_thrive_wistia").length) && (n.tve_has_wistia_popover = 1), n = TVE.apply_filters("tcb_save_post_data_after", n)
                                    },
                                    process_saved_template: function (e, t, r, i, c) {
                                        ...
                                        var n, a, s = t.wrapAll("<div></div>").parent();
                                        if (e = jQuery.trim(e)) for (var o = e.match(/[^{}]+(?=\})/g), l = e.match(/\[(.*?)\]([^\{]*)/g), d = {}, _ = l ? l.length : 0, h = 0; h < _; h++) {
                                            var v = l[h].match(/\[data-tve-custom-colour=([^0-9]{1,1})(\d+)('|")\]/);
                                            if (v && !(v.length < 3)) {
                                                var u = void 0 !== d["code" + v[2]] ? d["code" + v[2]] : (n = s.find('[data-tve-custom-colour="' + v[2] + '"]'), a = Math.floor(1e8 * Math.random() + 1), n.attr("data-tve-custom-colour", a), a),
                                                    f = l[h].replace(v[2], u);
                                                TVE.compat.insert_css_rule(f, o[h], TVE.stylesheet.cssRules.length), d["code" + v[2]] = u
                                            }
                                        }
                                        if (i && jQuery.each(i, function (e, t) {
                                            ...
                                            var p = {};
                                            jQuery.each(r, function (a, e) {
                                                var s = (e = e.replace(/data-css='(.+?)'/g, 'data-css="$1"')).match(/[^{}]+(?=\})/g),
                                                    t = e.match(/([^\r\n{}]+)(,(?=[^}]*{)|\s*){/g);
                                                if (!s || !t || s.length !== t.length) return !0;
                                                var o = TVE.CSS_Rule_Cache.media_rule(a), l = void 0;
                                                t = t.map(jQuery.trim), s = s.map(jQuery.trim);
                                                for (var r, i = function (i, n) {
                                                    if (!s[n].trim()) return "break";
                                                    var e = i.match(/tve-u-(.[^ "]*)/g);
                                                    g.each(e, function (e, t) {
                                                        if (p[l = t] = p[l] || TVE.CSS_Rule_Cache.generate_id(), i = i.replace(new RegExp("(" + l + ")", "g"), p[l]), i = jQuery.trim(i), i = TVE.apply_filters("tcb.content_selector_prefix", i), !(c && TVE.hasHeadCss(i.replace("{", "").trim(), !0, a) || (o.insertRule(i + s[n] + "}", o.cssRules.length), a !== TVE.main.responsive.desktop.media || -1 === i.indexOf(":hover")))) {
                                                            var r = i.split(",").map(function (e) {
                                                                var t = e.replace(/^([^:]+):hover/g, "$1.tve-state-hover");
                                                                return t === e && (t = e.replace(/(\s+)([^:]+):hover/g, "$1.tve-state-hover$2")), t
                                                            }).join(",");
                                                            o.insertRule(r + s[n] + "}", o.cssRules.length)
                                                        }
                                                    }), r = i
                                                }, n = 0; (r = t[n]) && "break" !== i(r, n); n++) ;
                                            }), g.each(p, function (e, t) {
                                                s.find('[data-css="' + e + '"]').attr("data-css", t)
                                            })
                                        }
                                        return s.find(".thrv_widget_menu").each(function () {
                                            var e = g(this),
                                                t = TVE.Editor_Page.thriveShrtcodeConfig(e.find(".thrive-shortcode-config"), "widget_menu"),
                                                r = t.get();
                                            void 0 !== d && g.each(["ul_attr", "top_link_attr", "link_attr", "trigger_attr"], function (e, t) {
                                                r[t] && d["code" + r[t]] && (r[t] = d["code" + r[t]])
                                            }), "undefined" != typeof id_map && r.head_css && id_map[r.head_css] && (r.head_css = id_map[r.head_css]), t.save(r)
                                        }), TVE.compat.texts(s), s.html()
                                    },
                                    insert_head_css: function (e, c) {
                                        var d = g('<style type="text/css"></style>').text(e).appendTo("head"),
                                            _ = TVE.ActiveElement ? TVE.ActiveElement.closest(".thrv_symbol") : g(),
                                            h = g.Deferred();
                                    ...
                                    TVE.main.on("device_hide_element", function (e) {
                                        ...
                                        switch (r) {
                                            case"paragraphFormat":
                                                t.$oel.is(TVE.TEXT_HEADINGS) && t.$oel.attr("data-tag", i.toLowerCase()), TVE.Components.text.clear_formatting();
                                                break;
                                            case"tcbParagraph":
                                        ...
                                        TVE.Editor_Page.editor.off("mouseenter.froala-editor").on("mouseenter.froala-editor", e, function (e) {
                                            ...
                                            if (!0 !== TVE.apply_filters("tcb.froala.non_editable", !1, n)) {
                                                ...
                                                c.extend(o, {
                                                    ...
                                                    return c(r).children(t.tcb.BLOCK_ELEMENTS).not("a").contents().unwrap(), r.innerHTML
                                                }))
                                            }
                                        ...
                                        e.replaceWith(t), setTimeout(function () {
                                ...
                                !function (w) {
                                    var e = {
                                        ...
                                        STATE_DRAG: "drag",
                                        state: function (e) {
                                            return void 0 === e ? this.CUR_STATE : (e !== this.CUR_STATE && (TVE.main.trigger("exitstate_" + this.CUR_STATE, e), TVE.main.trigger("enterstate_" + e, this.CUR_STATE), w("body").toggleClass("tcb-edit-mode", e === this.STATE_EDIT), this.CUR_STATE = e), this)
                                        },
                                        allow_drag: function () {
                                            return !0
                                        },
                                    ...
                                    function x(e, t, r) {
                                        var i = r, n = "";
                                        return e && (i += '[data-css="' + e + '"]'), t ? (w.isArray(t) || (t = [t]), w.each(t, function (e) {
                                            n += (e ? ", " : "") + i + this
                                        }), n) : i
                                    }
                                    ...
                                    e.CUR_STATE = e.STATE_DEFAULT, w.fn.extend({
                                        head_css: function (c, d, _, s, h) {
                                            void 0 === _ && (_ = ""), void 0 === h && (h = ""), _ = TVE.apply_filters("tcb_head_css_suffix", _, this), h = TVE.apply_filters("tcb_head_css_prefix", h, this);
                                            var n = w.isArray(c), v = this;
                                            if ("string" == typeof c || n) {
                                                var o = function (i, e) {
                                                    if (!_) return i.css(e);
                                                    if (w.isArray(_) && (w.each(_, function (e, t) {
                                                            var r = t.split("::")[0];
                                                            if (i.find(r).length) return _ = r, !1
                                                        }), w.isArray(_) && (_ = !1)), _ && -1 !== _.indexOf("::")) {
                                                        var t = _.split("::"), r = ":" + t.pop();
                                                        if (t[0] && (i = i.find(t[0])), _ = t[0], i.length) return s = !1, a(window.getComputedStyle(i[0], r), e, n)
                                                    }
                                                    return (_ ? i.find(_) : i).css(e)
                                                }, a = function t(r, e, i) {
                                                    if (i) {
                                                        var n = {};
                                                    ...
                                                    return !a && s && (a = o(v, e)), a
                                                };
                                                if (!this.length) return "";
                                                var e, t, r, i = this[0], l = i.dataset.css, u = !1;
                                                if (d = d || TVE.main.media_query_tpl(), e = TVE.CSS_Rule_Cache.media_rule(d), TVE.state_manager.is_hover() || TVE.FLAGS.hover_element) {
                                                    var f = TVE.apply_filters("hover_prefix_selector", "#tve_editor", v[0]) + " ";
                                                    if (TVE.USE_GLOBALSHEET) {
                                                        var p = TVE.getClassThatContains(v[0], TVE.CONST.global_cls_prefix) + ".tve-state-hover";
                                                        r = TVE.apply_filters("global_style_selector", x(!1, _, f + "." + p), p, f, v)
                                                    } else if (l) {
                                                        var g = x(l, _, h), m = g.split(", ");
                                                        if (TVE.state_manager.is_child()) {
                                                            ...
                                                            var V;
                                                            V = v.attr("data-selector") ? "[" + v.attr("data-selector") + "]" : '[data-css="' + TVE.CSS_Rule_Cache.uniq_id(v) + '"]', w.each(m, function (e, t) {
                                                                ...
                                                                m[e] = m[e] + t.replace(V, ""), m[e] = f + m[e].replace(f, ""), m[e] = w.trim(m[e].replace(/([ ]{2,})/g, " "))
                                                            })
                                                        }
                                                        r = m.join(", ")
                                                    ...
                                                    r = r.replace(/(\s{2,})/g, " "), e && (t = e.style_by_selector(r, !1)) && (u = a(t, c, n))
                                                }
                                                return s && !u && (u = o(v, c)), u || (u = n ? {} : ""), u
                                            }
                                            return this.each(function () {
                                                var e, t = this.dataset.css;
                                                if (TVE.USE_GLOBALSHEET) {
                                                    var r = TVE.getClassThatContains(v, TVE.CONST.global_cls_prefix);
                                                    e = TVE.apply_filters("global_style_selector", x(!1, _, h + "." + r), r, h, v)
                                                    ...
                                                    if (TVE.apply_filters("tcb.generate_new_css_id", t, this)) if (TVE.apply_filters("regenerate_css_id", 1 < TVE.Editor_Page.editor.find('[data-css="' + t + '"]').length, t)) {
                                                        var i = TVE.CSS_Rule_Cache.generate_id();
                                                        this.setAttribute("data-css", i), TVE.head_css_copy(t, i), t = i
                                                    } else {
                                                        for (var n, a = TVE.main.all_media(), s = 0, o = TVE.getActiveStylesheet().key, l = 0; n = a[l++];) -1 !== TVE.CSS_Rule_Cache[o][n].cssText.indexOf(t) && s++;
                                                        TVE.apply_filters("set_new_css_id", 0 === s, t) && !w(this).data("keep-css_id") && (t = TVE.CSS_Rule_Cache.uniq_id(this, !0))
                                                    } else t = TVE.apply_filters("tcb.head_css_new_id", TVE.CSS_Rule_Cache.uniq_id(this));
                                                    e = x(t, _, h)
                                                }
                                                e = e.replace(/(\s{2,})/g, " "), TVE.head_css(e, c, d, this)
                                            })
                                        ...
                                        if (this.flag_modify_hover_selector && TVE.state_manager.is_hover()) {
                                            ...
                                            if (TVE.state_manager.is_child()) {
                                                var c = TVE.state_manager.get_parent(),
                                                    ...
                                                    _ = -1 !== e.indexOf(s);
                                                o = e.split(", "), w.each(o, function (e, t) {
                                                    t = t.replace(s, ""), l[e] = (_ ? s : "") + d + TVE.state_manager.css_class() + " " + t, o[e] = (_ ? s : "") + d + TVE.state_manager.get_pseudo() + " " + t
                                                })
                                            } else {
                                                var h;
                                                void 0 !== i && TVE.state_manager.needs_hover_state_parent(i) && w.each(TVE.ActiveElement, function (e, t) {
                                                    if (TVE.inner_$(t).find(i).length) return i = TVE.ActiveElement[e], !1
                                                }), i = (i = void 0 === i ? TVE.ActiveElement[0] : i).jquery ? i[0] : i, h = TVE.USE_GLOBALSHEET ? TVE.getClassThatContains(i, TVE.CONST.global_cls_prefix) : i.dataset.selector ? i.dataset.selector : '[data-css="' + TVE.CSS_Rule_Cache.uniq_id(i) + '"]', TVE.USE_GLOBALSHEET && 0 < jQuery(i).find('[data-tcb_hover_state_parent="1"]').length && e.trim() !== "." + h ? w.each(o, function (e, t) {
                                        ...
                                        if (TVE.SKIP_CSS_STATE) TVE.UNDO_RULES || (TVE.UNDO_RULES = TVE.head_css_get(t, r, i, !1)); else {
                                            TVE.UNDO_RULES && w.each(r, function (e, t) {
                                        ...
                                        function a(i) {
                                            w.each(t, function (e, t) {
                                                var r = "";
                                                "string" == typeof t && -1 !== t.indexOf("important") && (t = w.trim(t.replace(/!(\s*)important/, "")), r = "important"), t || i.removeProperty(e), n && (r = "important"), i.setProperty(e, t, r)
                                            })
                                        }
                                        ...
                                        for (var o, l = 0; o = (r = "_ALL" === (r = r || TVE.main.media_query_tpl()) ? TVE.main.all_media() : Array.isArray(r) ? r : [r])[l++];) {
                                            ...
                                            w.isPlainObject(t) ? w.each(t, function (e, t) {
                                        ...
                                        page_index: Math.floor(1e5 * Math.random()), uniq_id: function (e, t) {
                                            ...
                                            w.each(TVE.main.responsive, function (e, t) {
                                                delete r[i][t.media]
                                            })
                                        }, init: function (e) {
                                            var r = this;
                                            void 0 === e && (e = !1), w.each(TVE.main.responsive, function (e, t) {
                                            ...
                                            var s = {};
                                            return w.each(e.split(";"), function (e, t) {
                                                var r = t.split(":"), i = w.trim(r[0]), n = w.trim(r[1]);
                                            ...
                                            var s = this,
                                                ...
                                                _ = {};
                                            return w.each(TVE.main.responsive, function (e, n) {
                                                l[n.media] = {}, w.each(s.media_rule(n.media).cssRules, function (e, t) {
                                            ...
                                            return w.each(TVE.main.responsive, function (e, t) {
                                                var r = i.media_rule(t.media);
                                                w.each(r.cssRules, function (e, t) {
                                                    var r, i;
                                        ...
                                        TVE.overlaySensor && TVE.overlaySensor.disconnect(), delete TVE.overlaySensor, w(".tve-element-mask").remove()
                                    }, e.body_overlay = function (e) {
                                        if (e = void 0 === e ? {} : e, !w(".tve-background-overlay").length) {
                                            var t = w('<div class="tve-background-overlay"></div>').css(e);
                                            TVE.inner.$body.append(t)
                                        }
                                    }, e.remove_body_overlay = function () {
                                        w(".tve-background-overlay").remove()
                                    }, e.generateElementPreview = function (e, t, r, i) {
                                        var n = w('<div id="tcb-template-clone-elem" style="position: absolute; left: -8000px; bottom: -5000px;"></div>').append(e.clone());
                                ...
                                n = jQuery, t.exports = {
                                    selectors: r("./selectors"), $root: null, is_disabled: function () {
                                        ...
                                        if (n(e.target).is(TVE.TEXT_ALL)) return !1;
                                    ...
                                    !function (f) {
                                        ...
                                        e.prototype.getRange = function (e, t) {
                                            ...
                                            if (-1 !== e) {
                                                ...
                                                a[t](n.append(s)), TVE.do_action("tcb.table_update_rows_colors"), TVE.drag.bind_draggable(n)
                                            } else {
