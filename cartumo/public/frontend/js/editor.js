    ...
    $(".embed-video-wrapper").find('.video-holder').each(function (index, element) {
        ...
        if ($(img_attr).attr('data-video-type') == 'youtube') {
            ...
            if ($(img_attr).attr('data-video-url')) {
                ...
                //for extra query string
                if ( typeof link[1] != 'undefined' ) {
                    if (link[1].lastIndexOf('&') >= 0) {
                        var part_1 = link[1].split('&');
                        url += part_1[0];
                    } else {
                        //no query string
                        url += link[1];
...
if ($(".element-button").attr('data-url') != null) {
    ...
    $(".element-button").click(function (e) {
        ...
        if ($(this).attr('data-url') == 'add_to_cart') {
            ...
            if (($(this).attr('href') == '#skip_step') || ($(this).attr('href') == '#')) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (json.status == 'success') {
                ...
                $("#order_confirmation_email_address").text(order.customer.email);

                var shipping_html = "<ul>";
                shipping_html += "<li><strong>First name: </strong><br>" + order.shipping.first_name + "</li>";
                shipping_html += "<li><strong>Last name: </strong><br>" + order.shipping.last_name + "</li>";
                shipping_html += "<li><strong>Address: </strong><br>" + order.shipping.address1 + "</li>";
                shipping_html += "<li><strong>Phone: </strong><br>" + order.shipping.phone + "</li>";
                shipping_html += "<li><strong>City: </strong><br>" + order.shipping.city + "</li>";
                shipping_html += "<li><strong>Province: </strong><br>" + order.shipping.province + "</li>";
                shipping_html += "<li><strong>Country: </strong><br>" + order.shipping.country + "</li>";
                shipping_html += "<li><strong>Zip: </strong><br>" + order.shipping.zip + "</li>";
                shipping_html += "</ul>";

                var billing_html = "<ul>";
                billing_html += "<li><strong>First name: </strong><br>" + order.billing.first_name + "</li>";
                billing_html += "<li><strong>Last name: </strong><br>" + order.billing.last_name + "</li>";
                billing_html += "<li><strong>Address: </strong><br>" + order.billing.address1 + "</li>";
                billing_html += "<li><strong>Phone: </strong><br>" + order.billing.phone + "</li>";
                billing_html += "<li><strong>City: </strong><br>" + order.billing.city + "</li>";
                billing_html += "<li><strong>Province: </strong><br>" + order.billing.province + "</li>";
                billing_html += "<li><strong>Country: </strong><br>" + order.billing.country + "</li>";
                billing_html += "<li><strong>Zip: </strong><br>" + order.billing.zip + "</li>";
                billing_html += "</ul>";

                $(".element-order-info #order_shipping_address").html(shipping_html);
                $(".element-order-info #order_billing_address").html(billing_html);
...
if ($(".product-cart-wrapper").length > 0) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (json.status == 'success')
                $(".product-cart-switch").html(json.html);
            else {
        ...
        complete: function () {
            ...
            //update bump
            if (typeof $(".product-bump-switch") != 'undefined') {

                var element = $(".product-bump-switch");

                $.ajax({
                    type: 'post',
                    url: $("#hid_base_url").val() + '/product/bupm/update-on-fly',
                    data: '_token=' + $("#csrf_token").val() + '&page_id=' + $("#hid_page_id").val(),
                    success: function (response) {
                        console.log(response);
                        var json = JSON.parse(response);
                        ...
                        if (json.status == 'success') {
                            $(element).find("input[name='bump[product_id]']").val(json.bump_product_id);
                        }
                    },
                    error: function (a, b) {
                        document.write(a.responseText);
