...
<head>
    ...
    <title>CARTUMO Developer | @yield('title')</title>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li>
                                <a href="{{ route('developer.dashboard') }}"><i class="fa fa-home"></i> Home <span
                                            class="fa fa-chevron-down"></span></a>
                            </li>

                            <li><a href="{{ route('developer.templates.index') }}"> <i class="fa fa-file-image-o" aria-hidden="true"></i>
                                    Templates <span class="fa fa-chevron-down"></span></a></li>
            ...
            <div class="nav_menu">
                <nav>
                    ...
                    <div class="nav toggles pull-left" style="margin-top: 0px;position: absolute;left: 0px;z-index: 99999;">
                        ...
                        <img src="{{ asset('images/logo1.png') }}" class="company-logo" style="width:167px;padding: 10px" />
                    </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li><a href="{{ route('payment-gateway.index') }}"><i class="fa fa-shopping-cart"></i>
                                        &nbsp; Payment
                                        Gateways</a></li>
                                <li><a href="{{ route('developer.logout') }}"><i class="fa fa-sign-out"></i> &nbsp; Log Out</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li role="presentation" class="">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"
                               aria-expanded="false">
                               <i class="fa fa-map" aria-hidden="true"></i> Marketplace
                                <!--<span class=" fa fa-angle-down"></span>-->
                            </a>
                        </li>
