        ...
        @else
            <div id="cm-builder">
                <div class="cm-builder-inner">
                    <div class="cm-section-wrapper ui-droppable ui-sortable">
                        <div class="cmb-wrapper cmb-widget-container-box cmb-elem-default-pad">
                            <div class="cmb-container-box-background cmb-widget-background"></div>
                            <!-- When the first element will be added, "cmb-parent-placeholder-empty" will removed from class list -->
                            <div class="cmb-cb cmb-parent-placeholder-empty ui-droppable ui-sortable">
