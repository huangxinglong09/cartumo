        ...
        @else
            <div id="cm-builder">
                <div class="cm-builder-inner">
                    <div class="cm-section-wrapper ui-droppable">
                        <div class="cmb-add-new-section cmb-parent-placeholder-empty">
                            <div class="cmb-replaceable-placeholder">
                                <button type="button" class="btn cmb-btn-add-new right-sidebar-expand-toggle" data-allowed-widget-items="section">
                                    <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Click New Section
                                </button>
                            </div>
                        </div>
                    </div>
